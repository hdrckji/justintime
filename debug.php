...
$debugAllowed = strtolower((string) env_or_default('JIT_ALLOW_DEBUG', '0'));
if (!$isLocal && !in_array($debugAllowed, ['1', 'true', 'yes', 'on'], true)) {
    http_response_code(403);
    exit('debug.php est desactive en production.');
}
